...
public class IntroScreens {
    ...
    public static ArrayList<IntroScreenList> getScreen() {
        ...
        screenList = new IntroScreenList("Download your favourite posts", R.drawable.ic_download_posts, "InstaSaver let you download Instagram stories,profile picture and many more.");
        introScreenLists.add(screenList);
