...
import com.blackpaper.InstaDownload.stories.profile.post.download.adapter.StoryViewPagerAdapter;
import com.blackpaper.InstaDownload.stories.profile.post.download.models.StoryModel;
import com.blackpaper.InstaDownload.stories.profile.post.download.utils.DataHolder;
...
public class ViewStoryActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener, StoryListener {
    ...
    private int count;
    boolean isDownloadPostImage,isAlreadyDownloaded;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadStories();
        adapter = new StoryViewPagerAdapter(getSupportFragmentManager(), modelList, isFromNet, urls,isDownloadPostImage,isAlreadyDownloaded);
