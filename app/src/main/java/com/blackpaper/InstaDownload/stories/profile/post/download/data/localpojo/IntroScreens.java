package com.blackpaper.InstaDownload.stories.profile.post.download.data.localpojo;
...
public class IntroScreens {
    ...
    public static ArrayList<IntroScreenList> getScreen() {
        ...
        screenList = new IntroScreenList("Download your favourite picture", R.drawable.ic_download_posts, "InstaDownload let you download Instagram stories,profile picture and many more.");
        introScreenLists.add(screenList);
